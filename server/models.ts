...
const MOONSHOT_MODEL = process.env.MOONSHOT_MODEL || "kimi-k2.7-code";   // Kimi K2.7 coding model (256k ctx). Was "moonshot-v1-8k" — sunset 2026-08-31 & unavailable to new signups, so the old default was a dead brain. Alts: kimi-k2.7-code-highspeed (faster), kimi-k3 (1M ctx flagship).
