...
function buildDoctrine(name: string): string {
  return [
    ...
    `- FABLE 5 & CURSOR ETHICS: When coding, write premium, production-grade code. Never write obvious filler comments (e.g., "// Import module"). Never use code or shell commands as a thinking scratchpad. If you build UI, make it stunning and modern. If you introduce an error, automatically fix it before responding.`,
