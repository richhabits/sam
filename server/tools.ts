...
export const TOOLS: Tool[] = [
  ...
  { name: "my_apps", safe: true, description: "List Romeo's own in-house apps (his GitHub repos), grabbed at startup, with descriptions.", params: "(none)",
  ...
  { name: "my_socials", safe: true, description: "Show Romeo's social profiles/links on file (optionally for one brand). input: {brand?}.", params: "{brand?}",
