...
export const PROVIDER_REGISTRY: ProviderSpec[] = [
  ...
  { id: "together", label: "Together AI", tier: "free", envPlural: "TOGETHER_API_KEYS", envSingular: "TOGETHER_API_KEY", starter: true, note: "🧠 reasoning + 🎨 FREE images (FLUX)", url: "https://api.together.xyz/settings/api-keys" },
  { id: "deepseek", label: "DeepSeek", tier: "free", envPlural: "DEEPSEEK_API_KEYS", envSingular: "DEEPSEEK_API_KEY", starter: true, note: "🧠 deep reasoning + 💻 code — the heavy thinker", url: "https://platform.deepseek.com/api_keys" },
  { id: "sambanova", label: "SambaNova", tier: "free", envPlural: "SAMBANOVA_API_KEYS", envSingular: "SAMBANOVA_API_KEY", starter: true, note: "⚡ fast chat — very quick 70B", url: "https://cloud.sambanova.ai" },
  ...
  { id: "novita", label: "Novita", tier: "free", envPlural: "NOVITA_API_KEYS", envSingular: "NOVITA_API_KEY", starter: true, note: "🎬 VIDEO generation + chat (free credits)", url: "https://novita.ai/settings/key-management" },
  ...
  { id: "siliconflow", label: "SiliconFlow", tier: "free", envPlural: "SILICONFLOW_API_KEYS", envSingular: "SILICONFLOW_API_KEY", starter: true, note: "🎨 images + 🎬 video + chat (free tier)", url: "https://cloud.siliconflow.cn/account/ak" },
  { id: "alibaba", label: "Qwen (Alibaba)", tier: "free", envPlural: "ALIBABA_API_KEYS", envSingular: "ALIBABA_API_KEY", starter: true, note: "🧠 reasoning (Qwen) — strong thinker", url: "https://bailian.console.alibabacloud.com" },
  { id: "moonshot", label: "Moonshot (Kimi)", tier: "premium", envPlural: "MOONSHOT_API_KEYS", envSingular: "MOONSHOT_API_KEY", note: "📚 long documents (Kimi) — huge context · needs credit (~$10 unlocks Tier1)", url: "https://platform.moonshot.ai/console/api-keys" },
  { id: "zhipu", label: "Zhipu GLM-5.2", tier: "free", envPlural: "ZHIPU_API_KEYS", envSingular: "ZHIPU_API_KEY", note: "🧠💻 NEW flagship — 1M context, top coder (20M free tokens)", url: "https://open.bigmodel.cn", starter: true, keyPattern: "^[A-Za-z0-9]{24,}\\.[A-Za-z0-9]{12,}$" },
  ...
  { id: "volcengine", label: "Doubao (Volcengine)", tier: "free", envPlural: "VOLCENGINE_API_KEYS", envSingular: "VOLCENGINE_API_KEY", starter: true, note: "💬 general chat — ByteDance", url: "https://console.volcengine.com/ark" },
