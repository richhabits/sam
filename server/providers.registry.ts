...
export const PROVIDER_REGISTRY: ProviderSpec[] = [
  ...
  { id: "zhipu", label: "Zhipu GLM-5.2", tier: "free", envPlural: "ZHIPU_API_KEYS", envSingular: "ZHIPU_API_KEY", note: "🧠💻 NEW flagship — 1M context, top coder (20M free tokens)", url: "https://open.bigmodel.cn", starter: true },
