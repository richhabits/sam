...
export const PROVIDER_REGISTRY: ProviderSpec[] = [
  ...
  { id: "moonshot", label: "Moonshot (Kimi)", tier: "free", envPlural: "MOONSHOT_API_KEYS", envSingular: "MOONSHOT_API_KEY", note: "📚 long documents (Kimi) — huge context", url: "https://platform.moonshot.ai/console/api-keys", starter: true },
