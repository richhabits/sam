...
```
**macOS · Linux — one paste.** Windows: `irm https://raw.githubusercontent.com/richhabits/sam/main/docs/install.ps1 | iex`
...
- 📐️ **191 real tools** — web, files, terminal, email, iMessage, calls, calendar, music, camera & vision, screenshots, **GitHub (read, commit, push, PRs)**.
...
| **Takes real actions** | ✅ 192 tools | ⚠️ limited | ❌ mostly chat |
