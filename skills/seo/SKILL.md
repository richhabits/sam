...
name: SEO
tier: free
triggers: seo, keyword, meta description, title tag, rank, search engine, backlink, on-page, serp, google ranking, alt text, slug
---
...
- Explain the 'why' in one line so he learns.
## Output
The optimised assets, then 2-3 quick wins for the page.
