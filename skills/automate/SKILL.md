...
name: Automate
tier: premium
triggers: automate, workflow, script, every day, recurring, schedule, batch, repetitive, set up automation, do this every
---
...
- Explain in plain words what the automation does and how to trigger it again.
## Output
The plan, then offer to build it step by step with the tools.
