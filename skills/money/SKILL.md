...
tier: premium
triggers: budget, savings, tax, pension, invoice, expenses, personal finance, cash, mortgage, isa, income, spending, self assessment
---
...
- UK context (ISA, self-assessment, allowances) by default.
## Output
The answer with the numbers, then the smartest next move.
