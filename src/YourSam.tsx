        ...
        {!s ? <div className="drawer-empty">Loading…</div> : (
          <>
            ...
            <div className="ys-tel">
              <button className={"au-behavior" + (s.telemetry.enabled ? " on" : "")} onClick={toggleTelemetry}>
              ...
              <button className="ys-preview-btn" onClick={showPreview}>See exactly what would be sent →</button>
              {preview !== undefined && (
